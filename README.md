...
```
npx degit wighawag/rekojeu <your-app-folder>
```
...
```
npx degit wighawag/rekojeu#nft <your-app-folder>
```
-->
...
this will update name of the project (by default "rekojeu") to be the name of the folder (See `set-name` command) and install the dependencies (`pnpm install`)
<br/><br/>

`pnpm set-name [<new name>]`

This will replace every instance of `rekojeu` (or whatever name was set) to `new name` (if specified, otherwise it use the folder name)
